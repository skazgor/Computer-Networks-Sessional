...
print(x)
print(yt)
plt.plot(x,yt, label="Transmission Range vs Throughtput")
plt.xlabel('Transmission Range')
plt.ylabel('Throughput')
plt.savefig('Fig/TransmissionRangevsThroughput.png')
plt.close()
print(ya)
plt.plot(x,ya, label="Transmission Range vs Average Delay")
plt.xlabel('Transmission Range')
plt.ylabel('Average Delay')
plt.savefig('Fig/TransmissionRangevsAverageDelay.png')
plt.close()
print(yd)
plt.plot(x,yd, label="Transmission Range vs Delivery ratio")
plt.xlabel('Transmission Range')
plt.ylabel('Delivery ratio')
plt.savefig('Fig/TransmissionRangevsDeliveryRatio.png')
plt.close()
print(ydr)
plt.plot(x,ydr, label="Transmission Range vs Drop ratio")
plt.xlabel('Transmission Range')
plt.ylabel('Drop ratio')
plt.savefig('Fig/TransmissionRangevsDropRatio.png')
plt.close()
print(ey)
plt.plot(x,ey, label="Transmission Range vs Total Energy Consumption")
plt.xlabel('Transmission Range')
plt.ylabel('Total Energy Consumption')
plt.savefig('Fig/TransmissionRangevsTotalEnergyConsumption.png')
plt.close()
print(epby)
plt.plot(x,epby, label="Transmission Range vs Energy Consumption per Byte")
plt.xlabel('Transmission Range')
plt.ylabel('Energy Consumption per Byte')
plt.savefig('Fig/TransmissionRangevsEnergyConsumptionperByte.png')
plt.close()
number_of_range=100
for arr in x_individual:
    print(arr)
    x_axis=range(1,arr.__len__()+1)
    plt.plot(x_axis,arr, label=f"Transmission Range({number_of_range})vs per Node Throughput")
    plt.xlabel('Transmission Range')
    plt.ylabel('per Node Throughput')
    plt.savefig(f'Fig/TransmissionRange({number_of_range})vsperNodeThroughput.png')
    plt.close()
    number_of_range+=100
